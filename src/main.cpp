...
#if defined(NDEBUG)
# error "ReferralCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "ReferralCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    {
		nSubsidy = 100000000 * COIN;  // 1000mil
    } 
...
#ifdef ENABLE_WALLET
// ReferralCoin: attempt to generate suitable proof-of-stake
...
{
    RenameThread("ReferralCoin-loadblk");
