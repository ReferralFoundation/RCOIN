...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "22 Nov 2016 Changing The Essence Of Economics Pt. 1";
...
//error("genesis.hashMerkleRoot=");
//error(genesis.hashMerkleRoot.ToString().c_str());
//error("\n\n");

        assert(hashGenesisBlock == uint256("0x4abdfa55bcff5dee549a1f04454645a2e566f92f9498e7b0f09afa86a480b620"));
        assert(genesis.hashMerkleRoot == uint256("6757b0faab535fdd0c1d4f86bfbb6b0b5ae9ecb5e3044ae9294e385b768bdcde"));

        vSeeds.push_back(CDNSSeedData("54.245.155.191", "54.245.155.191"));
        vSeeds.push_back(CDNSSeedData("a-node.referralcoins.com", "a-node.referralcoins.com"));
        vSeeds.push_back(CDNSSeedData("b-node.referralcoins.com", "b-node.referralcoins.com"));
        vSeeds.push_back(CDNSSeedData("c-node.referralcoins.com", "c-node.referralcoins.com"));
        vSeeds.push_back(CDNSSeedData("d-node.referralcoins.com", "d-node.referralcoins.com"));
